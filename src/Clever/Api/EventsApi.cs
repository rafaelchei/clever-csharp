...
namespace Clever.Api
{
    ...
    public partial class EventsApi : IEventsApi
    {
        ...
        /// <returns></returns>
        public EventsApi(Clever.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< EventsResponse > GetEventsWithHttpInfo (int? limit = null, string startingAfter = null, string endingBefore = null, string school = null, List<string> recordType = null)
        {
            ...
            if (school != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "school", school)); // query parameter
            if (recordType != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("multi", "record_type", recordType)); // query parameter
