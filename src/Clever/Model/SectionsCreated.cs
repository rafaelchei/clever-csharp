...
namespace Clever.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SectionsCreated : Event,  IEquatable<SectionsCreated>, IValidatableObject
    {
        /// <summary>
        ...
        public SectionsCreated(SectionObject data = default(SectionObject), string created = default(string), string id = default(string), string type = "sections.created") : base(created, id, type)
        {
            this.Data = data;
        }
