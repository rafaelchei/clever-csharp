...
namespace Clever.Model
{
    ...
    public partial class Term :  IEquatable<Term>, IValidatableObject
    {
        ...
        public Term(string district = default(string), string endDate = default(string), string id = default(string), string name = default(string), string startDate = default(string))
        {
